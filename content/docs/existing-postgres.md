...
```bash
curl -fsSLO https://rvbbit.ai/dist/pg_rvbbit-4.1.2-pg18-amd64.tar.gz
curl -fsSL  https://rvbbit.ai/dist/pg_rvbbit-4.1.2-pg18-amd64.tar.gz.sha256 | sha256sum -c
tar xzf pg_rvbbit-4.1.2-pg18-amd64.tar.gz
sudo pg_rvbbit-4.1.2-pg18-amd64/install.sh    # copies into pg_config paths
```

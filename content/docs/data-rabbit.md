...
- **Native macOS app** (Apple silicon) — signed and notarized, no Docker
  ...
  ```
  https://rvbbit.ai/dist/mac/DataRabbit-4.1.4-arm64.dmg
...
- **Native Linux app** (x86_64) — AppImage (`chmod +x` and run) or `.deb`:
  ...
  ```
  https://rvbbit.ai/dist/linux/DataRabbit-4.1.4-x86_64.AppImage
  https://rvbbit.ai/dist/linux/DataRabbit-4.1.4-amd64.deb
  ```
